...
import formatToIDRCurrency from "../../src/Utils/formatToIDRCurrency"
...
export default function ProductDetail() {
  ...
  return (
   <>
    <Navbar></Navbar>
    <div className='flex px-24 py-4 gap-[48px] mt-[64px] items-center'>
          <Link to='/'>
    ...
    <div className='flex gap-[30px] px-24'>
            <div className=''>
                ...
                <img src={product.Img ?? (product.Namaproduct ?? 'No Name')} alt={product.Namaproduct ?? 'No Name'} className='block w-[700px] h-[500px] object-cover'/>
            </div>
